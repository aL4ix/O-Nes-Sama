...
Mapper003::Mapper003(CartIO& ioRef)
    : BasicMapper(ioRef)
{
}
Mapper087::Mapper087(CartIO& ioRef)
    : BasicMapper(ioRef)
{
}
Mapper101::Mapper101(CartIO& ioRef)
    : BasicMapper(ioRef)
{
}
Mapper145::Mapper145(CartIO& ioRef)
    : BasicMapper(ioRef)
{
}
Mapper149::Mapper149(CartIO& ioRef)
    : BasicMapper(ioRef)
{
}
Mapper185::Mapper185(CartIO& ioRef)
    : BasicMapper(ioRef)
{
}
